...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className='lg:mt-[100px] mt-[50px] relative'>
        <Image
          src={star}
          alt="star"
        ...
        />
        <h1 className='font-general-sans-semibold text-[70px] lg:w-2/3 w-full special-text leading-[81px] relative'>
      ...
      <p className='lg:w-3/5 font-general-sans-regular text-xl text-[#ffffff60] my-10'>
      ...
      <div className='flex items-center justify-between bg-[#9E33D7] lg:w-[18%] md:w-[28%] w-[40%] rounded-[10px] cursor-pointer'>
      ...
      <div className='relative my-[100px] flex justify-center items-center flex-col'>
        ...
        />
        <h1
          className='font-general-sans-semibold lg:text-[48px] md:text-[35px] text-[20px] text-center w-[55%] special-text absolute'
        >
      ...
      <div className="mb-[100px]">
        <h1 className="special-text font-general-sans-semibold text-3xl mb-5">Investment News</h1>
